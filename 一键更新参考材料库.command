...
SOURCE_XLSX="/Users/pirateli/Desktop/workbuddy/workbuddy共创营/参考材料库.xlsx"
PYTHON_BIN="/Users/pirateli/.cache/codex-runtimes/codex-primary-runtime/dependencies/python/bin/python3"
SYNC_SCRIPT="$REPO_DIR/scripts/sync_reference_materials_from_excel.py"
DATA_FILE="$REPO_DIR/data/reference-materials-data.js"
PAGE_FILE="$REPO_DIR/WB参考材料库.html"
...
COMMIT_MSG="Update reference materials $(date '+%Y-%m-%d %H:%M')"
